...
<body>
	...
	<div class = "container">
		...
		<form class = "col-md-6 form" action="/ProjWeb_SCC0219_Part3/Bridgeport/UserServlet" method="GET" id = "byEmail" accept-charset="utf-8">
		...
		<form class = "col-md-6 form" action="/ProjWeb_SCC0219_Part3/Bridgeport/UserServlet" method="GET" id = "byDate" accept-charset="utf-8">
