...
<body>
	...
	<div class= "container">
		<div class = "row cover" >
		<form class = "col-md-6 form" action="/ProjWeb_SCC0219_Part2/Bridgeport/ListHandler" method="get" id = "contact" autocomplete= "off">
		...
		<input class = "btn btn-lg btn-primary btn-block button " id = "submit" type="submit" value ="Send 
Message"/>
