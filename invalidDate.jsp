...
<div class= "navbar-wrapper">
	...
	<div class="container">
	<div class="row cover">
	<h2 class = "header">We are sorry...</h2>
	<p class= "text" >There are no rooms available for this date. :(<br/>

		to go back click <a class = "link" href="${pageContext.request.contextPath}/user.jsp"> here!!! </a></p>
